...
const inputCalc=document.querySelector(".calc__wrapper-input input"),calcRegister=document.querySelector(".calc__wrapper-result_register"),calcSubscriptions=document.querySelector(".calc__wrapper-result_subscriptions"),resultOutput=document.querySelector(".calc__wrapper-output_right");inputCalc&&inputCalc.addEventListener("input",()=>{calcRegister.innerHTML=300*inputCalc.value+" руб",calcSubscriptions.innerHTML=3e3*inputCalc.value+" руб",resultOutput.innerHTML=3e3*inputCalc.value+300*inputCalc.value+" руб"});const btn=document.querySelectorAll(".ask__dropdown-item_btn"),drop=document.querySelectorAll(".ask__dropdown-item_block"),item=document.querySelectorAll(".ask__dropdown-item");function dropResize(){item.forEach(e=>{e.style.maxHeight=e.querySelector(".ask__dropdown-item_btn").clientHeight+8+"px"})}window.addEventListener("resize",()=>{dropResize()}),dropResize(),btn.forEach(e=>{e.addEventListener("click",()=>{let t=e.parentElement.querySelector(".ask__dropdown-item_block").clientHeight+e.clientHeight,r=e.clientHeight,l=0,n=e.clientHeight;e.parentElement.classList.contains("ask__dropdown-item_active")?(e.parentElement.classList.remove("ask__dropdown-item_active"),console.log(n),l=setInterval(()=>{r>=n?e.parentElement.style.maxHeight=4+r--+"px":clearInterval(l)},100)):(e.parentElement.classList.add("ask__dropdown-item_active"),l=setInterval(()=>{r<=t?e.parentElement.style.maxHeight=(r+=3)+"px":clearInterval(l)},1))})});const swiper=new Swiper(".rewiews__wrapper",{pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,t){return'<span class="'+t+'">'+(e+1)+"</span>"}}}),swiperQuestin=new Swiper(".questin__wrapper",{slidesPerView:3,spaceBetween:20,pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,t){return'<span class="'+t+'">'+(e+1)+"</span>"}},breakpoints:{900:{slidesPerView:3},650:{slidesPerView:2},320:{slidesPerView:1}}}),swiperPress=new Swiper(".press__wrapper",{slidesPerView:4,spaceBetween:20,pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,t){return'<span class="'+t+'">'+(e+1)+"</span>"}},breakpoints:{1100:{slidesPerView:4},800:{slidesPerView:3},500:{slidesPerView:2},320:{slidesPerView:1}}}),model=document.querySelector(".model"),btnModel=document.querySelectorAll(".btn"),body=document.querySelector("body");model&&btnModel&&body&&btnModel.forEach(e=>{e.addEventListener("click",e=>{e.stopPropagation(),model.style.display="block",body.classList.add("body__model"),body.addEventListener("click",e=>{e.target!=model&&e.target!=model.querySelector(".model__title")&&e.target!=model.querySelector(".container")&&e.target!=model.querySelector(".model__subtitle")&&e.target!=model.querySelector(".model__text")&&e.target!=model.querySelector("input")&&e.target!=model.querySelector(".model__wrapper-input")&&e.target!=model.querySelector(".model__subtext")&&e.target!=model.querySelector(".model__wrapper-input:nth-child(3) .model__wrapper-input_point")&&e.target!=model.querySelector(".model__wrapper-input:nth-child(3) .model__wrapper-input_text")&&e.target!=model.querySelector(".model__wrapper-input:nth-child(3)")&&e.target!=model.querySelector(".model__wrapper-input")&&e.target!=model.querySelector(".model__wrapper-input_point")&&(console.log(e.target),model.style.display="none",body.classList.remove("body__model"))})})});const waitingSlider=new Swiper(".single__wrapper",{spaceBetween:20,pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,t){return'<span class="'+t+'">'+(e+1)+"</span>"}},breakpoints:{900:{slidesPerView:3},600:{slidesPerView:2},320:{slidesPerView:1}}}),hundredsSlider=new Swiper(".hundreds__wrapper",{spaceBetween:60,pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,t){return'<span class="'+t+'">'+(e+1)+"</span>"}},breakpoints:{1150:{slidesPerView:3,spaceBetween:60},700:{slidesPerView:2,spaceBetween:40},320:{slidesPerView:1,spaceBetween:20}}});